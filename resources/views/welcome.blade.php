...
<body>
  ...
  <div class="modal fade bd-example-modal-lg" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content" style="border-radius:20px;color: black; box-shadow: 0 0 10px rgba(0, 0, 0, 0.3);
    border-radius: 5px; background-color: #ffff">
        ...
        <div class="modal-body">
          <form action="{{route('category')}}" method="POST">
            @csrf
            <input text="text" type="text" name="category">
    ...
    <tbody>
      ...
      <tr class="table table-bordered">
        ...
        <td scope="row" style="text-align: center;">
          ...
          <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModal">
            <i class="fas fa-trash" style="color:#343a40"> Delete</i> 
          </a>
        </td>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>note:under maintence. not yet working</p>
        </div>
        <div class="modal-footer">
