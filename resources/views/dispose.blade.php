...
<body>
  ...
  filter: brightness(0.5);font-size: 25px; margin-left:-15;font-weight:bold;">Maintainance</h3>
    ...
    border-radius: 5px; background-color: rgba(220, 230, 255, 0.8);">
                ...
                <div class="modal-body">
                    <form action="{{route('dispose')}}" method="POST">
                        ...
                        <p></p>
                        <input type="text" name="acknowledgement" placeholder="Enter Acknoeledgement No.*" class="muted-text-input">
                </div>
   ...
   color:white; border-radius:10px;" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
    ...
    <table class="table table-borderless" style="justify-content: center; height: 30%;  width: 79%; margin-left:18%; background-color: white; color: black; font-size:13px;">
        ...
        <tbody>
            ...
            <tr>
                <!-- {{dd($incoming_item->getCategoryName())}} -->
                <td scope="row" style="text-align: center;">{{$incoming_item-> item_category}}</td>
